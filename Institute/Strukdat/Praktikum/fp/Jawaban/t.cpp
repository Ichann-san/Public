...
private:
    ...
    treenode* rotateright(treenode* y) {
        ...
        if(!rotate2) {
            cout << "Left Case" << endl;
            cout << "PivotNode: " << y->data << endl;
            cout << "PivotNode->left: " << x->data << endl;
            cout << "PivotNode->left->left: " << (x->left ? x->left->data : -1) << endl;
            cout << endl;
            cout << "result:" << endl;
            cout << "NewNode: " << x->data << endl;
            cout << "NewNode->left: " << (x->left ? x->left->data : -1) << endl;
            cout << "NewNode->right: " << y->data << endl;
            cout << endl;
    ...
    treenode* rotateleft(treenode* x) {
        ...
        if(!rotate2) {
            ...
            cout << "PivotNode: " << x->data << endl;
            cout << "PivotNode->right: " << y->data << endl;
            cout << "PivotNode->right->right: " << (y->right ? y->right->data : -1) << endl;
            cout << endl;
            cout << "result:" << endl;
            cout << "NewNode: " << y->data << endl;
            cout << "NewNode->left: " << x->data << endl;
            cout << "NewNode->right: " << (y->right ? y->right->data : -1) << endl;
            cout << endl;
        }
    ...
    treenode* rotateleftright(treenode* node) {
        ...
        treenode* lr = l ? l->right : nullptr;

        cout << "Left Right Case" << endl;
        cout << "PivotNode: " << pivot->data << endl;
        cout << "PivotNode->left: " << (l ? l->data : -1) << endl;
        cout << "PivotNode->left->right: " << (lr ? lr->data : -1) << endl;
        cout << endl;
        ...
        cout << "result:" << endl;
        cout << "NewNode: " << result->data << endl;
        cout << "NewNode->left: " << (result->left ? result->left->data : -1) << endl;
        cout << "NewNode->right: " << (result->right ? result->right->data : -1) << endl;
        cout << endl;
    ...
    treenode* rotaterightleft(treenode* node) {
        ...
        treenode* rl = r ? r->left : nullptr;

        cout << "Right Left Case" << endl;
        cout << "PivotNode: " << pivot->data << endl;
        cout << "PivotNode->right: " << (r ? r->data : -1) << endl;
        cout << "PivotNode->right->left: " << (rl ? rl->data : -1) << endl;
        cout << endl;
